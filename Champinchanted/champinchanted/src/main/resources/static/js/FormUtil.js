class FormUtil {
    ...
    addElement(elementId, elementType, config) {
        const element = document.createElement(elementType);  // Crea el tipo de elemento
        element.id = elementId;  // Asigna el ID
        element.style.width = config.width + "px";  // Establece el ancho
        element.style.height = config.height + "px";  // Establece la altura
        element.style.fontSize = config.fontSize + "px";  // Establece el tamaño de la fuente
        element.style.padding = config.padding + "px";  // Establece el padding
        element.placeholder = config.placeholder;  // Establece el placeholder si lo tiene
